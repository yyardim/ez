...
namespace EZ.Data
{
    ...
    /// EZ creates a new provider per client request.
    /// </remarks>
    public class RepositoryProvider : IRepositoryProvider
    {
        /// <summary>
        /// The <see cref="RepositoryFactories"/> with thich to create a new repository
        /// </summary>
        ...
        /// <p>This is an extension point. You can register fully made repositories here and they will be used instead of the ones this provider would otherwise create.</p>
        /// </remarks>
        ...
        /// </typeparam>
        /// <param name="factory">
        /// An optional repository creation function that takes a DbContext argument and returns a repository of T. 
        /// Used if the repository must be created and caller wants to specify the specific factory to use rather 
        /// than one of the injected <see cref="RepositoryFactories"/>
        /// </param>
        /// <rremarks>
        ...
        /// Usefule in testing and when developing without a backend impl. of the object returned by a repo of type T.
        /// </remarks>
